...
namespace SalvaLucro.Extensions
{
    public static class FormatCnpjCpf
    {
        ...
        public static string FormatCNPJ(string CNPJ)
        {
            return Convert.ToUInt64(SemFormatacao(CNPJ)).ToString(@"00\.000\.000\/0000\-00");
        }
        ...
        public static string FormatCPF(string CPF)
        {
            return Convert.ToUInt64(SemFormatacao(CPF)).ToString(@"000\.000\.000\-00");
        }
        /// <summary>
